...
<rapid:override name="content">
    ...
    <form class="layui-form" method="post" id="myForm" action="${pageContext.request.contextPath}/admin/article/editSubmit">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <label for="title"></label><input type="text" name="articleTitle" lay-verify="title" id="title" value="${article.articleTitle}"
                                                  class="layui-input">
            </div>
        </div>
        ...
        <div class="layui-form-item layui-form-text">
            ...
            <div class="layui-input-block">
                <label for="content"></label><textarea class="layui-textarea layui-hide" name="articleContent"
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <label for="articleParentCategoryId"></label><select name="articleParentCategoryId" id="articleParentCategoryId"
            ...
            <div class="layui-input-inline">
                <label for="articleChildCategoryId"></label><select name="articleChildCategoryId" id="articleChildCategoryId" lay-filter="articleChildCategoryId">
                    <c:forEach items="${categoryList}" var="c">
    ...
    <blockquote class="layui-elem-quote layui-quote-nm">
        温馨提示：
        1、插入代码前，可以点击 <a href="http://xust.com/code-highlight.html" target="_blank">代码高亮</a>,将代码转成HTML格式
    </blockquote>
